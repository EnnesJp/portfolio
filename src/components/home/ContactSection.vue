<template>
    <app-section :title="t('home.contactSection.title')" class="contact-section-wrapper">
        <div class="contact-section">
            <div class="contact-section__info">
                ...
                <div class="contact-methods">
                    <h3 class="contact-methods__title">{{ t('home.contactSection.contactMethods.title') }}</h3>
...
import { AppSection, ContactForm } from '@components'
...
const contactMethods = computed(() => contactData.value?.contactMethods || defaultContactMethods.value)
